...
@SpringBootTest
@Transactional
public class OrderSercie_IntegrationTest {
    ...
    @Test
    public void IT_TC_003_001_001_001(){
        printTestCaseCode("IT_TC_003_001_001_001");
        String id = "";
    ...
    @Test
    public void IT_TC_003_001_001_002(){
        printTestCaseCode("IT_TC_003_001_001_002");
        String id = TEST_USER;
...
//        Mockito.when(userRepo.findByUniUuid(id)).thenReturn(u);
    ...
    @Test
    public void IT_TC_003_001_001_003(){
        printTestCaseCode("IT_TC_003_001_001_003");
        String id = TEST_USER;
...
//        Assertions.assertThat(obj.getOrders().size()).isEqualTo(0);
    ...
    @Test
    public void IT_TC_003_001_002(){
        printTestCaseCode("IT_TC_003_001_002");
...
//        Mockito.when(userRepo.findByUniUuid(id)).thenReturn(null); // 用户不存在
    ...
    @Test
    public void IT_TC_003_001_003(){
        printTestCaseCode("IT_TC_003_001_003");
        String id = TEST_USER;
...
//        Mockito.when(userRepo.findByUniUuid(id)).thenReturn(u);
    ...
    @Test
    public void IT_TC_003_001_004_001(){
        printTestCaseCode("IT_TC_003_001_004_001");
        String id = TEST_USER;
...
//        Mockito.when(userRepo.findByUniUuid(id)).thenReturn(u);
    ...
    @Test
    public void IT_TC_003_001_004_002(){
        printTestCaseCode("IT_TC_003_001_004_001");
        String id = TEST_USER;
...
//        Mockito.when(userRepo.findByUniUuid(id)).thenReturn(u);
    ...
    @Test
    public void IT_TC_003_001_005(){
        printTestCaseCode("IT_TC_003_001_005");
        String id = TEST_USER;
...
//        Assertions.assertThat(obj.getTotalPage()).isEqualTo(1);
    ...
    // 操作订单具有副作用，所以需要在操作前恢复状态
    void  BeforeOperateOrder(int id)
    {
        System.out.println("把 id 为" + id + "的订单重置为 PLACED zhuangtai");
    ...
    @Test
    public void IT_TC_003_002_001_001(){
        printTestCaseCode("IT_TC_003_002_001_001");
...
//        Mockito.when(orderRepo.findByOrderId(id)).thenReturn(order);
    ...
    @Test
    public void IT_TC_003_002_001_002(){
        printTestCaseCode("IT_TC_003_002_001_002");

        int id = TEST_ORDER_PLACED;
        BeforeOperateOrder(id); // 重置状态
        JSONObject json = new JSONObject();
...
//        Mockito.when(orderRepo.findByOrderId(id)).thenReturn(order);
    ...
    @Test
    public void IT_TC_003_002_002(){
        printTestCaseCode("IT_TC_003_002_002");
...
//        Mockito.when(orderRepo.findByOrderId(id)).thenReturn(null);
    ...
    @Test
    public void IT_TC_003_002_003_001(){
        printTestCaseCode("IT_TC_003_002_001_002");
...
//        Mockito.when(orderRepo.findByOrderId(id)).thenReturn(order);
    ...
    @Test
    public void IT_TC_003_002_003_002(){
        printTestCaseCode("IT_TC_003_002_003_002");

        int id = TEST_ORDER_PLACED; // PLACED
        BeforeOperateOrder(id);
...
//        Mockito.when(orderRepo.findByOrderId(id)).thenReturn(order);
    ...
    @Test
    public void IT_TC_003_002_004(){
        printTestCaseCode("IT_TC_003_002_004");
...
//        Mockito.when(skillRepo.findBySkillId(skill_id)).thenReturn(skill);
    ...
    @Test
    public void IT_TC_003_003_001_001() throws ParseException {
        printTestCaseCode("IT_TC_003_003_001_001");
...
//        Mockito.when(userRepo.findByUniUuid(user_id)).thenReturn(user);
    ...
    @Test
    public void IT_TC_003_003_001_002() throws ParseException {
        printTestCaseCode("IT_TC_003_003_001_002");
...
//        Assertions.assertThat((int)result.getData()).isEqualTo(0); //
    ...
    @Test
    public void IT_TC_003_003_001_003() throws ParseException {
        printTestCaseCode("IT_TC_003_003_001_003");
...
//        Assertions.assertThat((int)result.getData()).isEqualTo(0); //
    ...
    @Test
    public void IT_TC_003_003_001_004() throws ParseException {
        printTestCaseCode("IT_TC_003_003_001_004");
...
//        Assertions.assertThat((int)result.getData()).isEqualTo(0); //
    ...
    @Test
    public void IT_TC_003_003_002() throws ParseException {
        printTestCaseCode("IT_TC_003_003_002");
...
//        Assertions.assertThat((int)result.getData()).isEqualTo(0); //
    ...
    @Test
    public void IT_TC_003_003_003() throws ParseException {
        printTestCaseCode("IT_TC_003_003_003");
...
//        Assertions.assertThat((int)result.getData()).isEqualTo(0); //
    ...
    @Test
    public void IT_TC_003_003_004() throws ParseException {
        printTestCaseCode("IT_TC_003_003_004");
...
//        Mockito.when(orderRepo.findByOrderId(0)).thenReturn(order);
    ...
    @Test
    public void IT_TC_003_003_005() throws ParseException {
        printTestCaseCode("IT_TC_003_003_005");
    ...
    public void IT_TC_003_003_006() throws ParseException {
        printTestCaseCode("IT_TC_003_003_006");
...
//        double val = 90.00;
    ...
    // ======================================  Apply Refund  ===================================== //
    @Test
    public void IT_TC_003_004_001_001() {
        printTestCaseCode("IT_TC_003_004_001_001");
...
//        fakeOrder("", order_id, null, -1.0);
    ...
    @Test
    public void IT_TC_003_004_001_002() throws ParseException {
        printTestCaseCode("IT_TC_003_004_001_002");
...
//        pics.add("2.jpg");
    ...
    @Test
    public void IT_TC_003_004_001_003() throws ParseException {
        printTestCaseCode("IT_TC_003_004_001_003");
...
//        String refund_time = "2019-12-17 10:30:10";
    ...
    @Test
    public void IT_TC_003_004_001_004() throws ParseException {
        printTestCaseCode("IT_TC_003_004_001_004");
...
//        String content = "不是很满意，这个差评我给定了！";
    ...
    @Test
    public void IT_TC_003_004_002() throws ParseException {
        printTestCaseCode("IT_TC_003_004_002");
...
//        Mockito.when(orderRepo.findByOrderId(order_id)).thenReturn(null);
    ...
    @Test
    public void IT_TC_003_004_003() throws ParseException {
        printTestCaseCode("IT_TC_003_004_003");
    ...
    @Test
    public void IT_TC_003_004_004() throws ParseException {
        printTestCaseCode("IT_TC_003_004_004");
    ...
    // =======================================  getOrderRequestDTOs  ========================================= //
    @Test
    public void IT_TC_003_005_001_001() {
        printTestCaseCode("IT_TC_003_005_001_001");
...
//    @Test
//    public void IT_TC_003_005_001_002() {
//        printTestCaseCode("IT_TC_003_005_001_002");
//
//        // 变量声明
//        String user_id = "test";
//        Integer page = null;
...
//    }
    ...
    @Test
    public void IT_TC_003_005_001_003() {
        printTestCaseCode("IT_TC_003_005_001_003");
...
//        fakeUser(user_id);
    ...
    @Test
    public void IT_TC_003_005_002() {
        printTestCaseCode("IT_TC_003_005_002");
...
//        Mockito.when(userRepo.findByUniUuid(user_id)).thenReturn(null);
    ...
    @Test
    public void IT_TC_003_005_003_001() {
        printTestCaseCode("IT_TC_003_005_003_001");
    ...
    @Test
    public void IT_TC_003_005_003_002() {
        printTestCaseCode("IT_TC_003_005_003_001");
    ...
    @Test
    public void IT_TC_003_005_004() {
        printTestCaseCode("IT_TC_003_005_004");
    ...
    @Test
    public void IT_TC_003_006_001() {
        printTestCaseCode("IT_TC_003_006_001");
